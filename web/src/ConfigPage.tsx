...
export function ConfigPage() {
  ...
  return <main className="workspace config-workspace">
    ...
    <ConfigSection title="Merge gate"><KV label="Auto merge" value={onOff(snap.mergeGate?.autoMerge === true)} /><KV label="Max diff lines" value={optional(snap.mergeGate?.maxDiffLines)} /><KV label="Max files" value={optional(snap.mergeGate?.maxFiles)} /><KV label="Verifier required" value={onOff(snap.mergeGate?.requireVerifierPass === true)} /></ConfigSection>
    ...
    <ConfigSection title="Resources"><KV label="Agents dir" value={snap.resources.agentsDir} /><KV label="Skills dir" value={snap.resources.skillsDir} /><KV label="Skills" value={snap.resources.skills.map((item) => item.name).join(", ") || "none"} /></ConfigSection>
