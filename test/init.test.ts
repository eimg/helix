...
test("init: listPresets returns all 5 stacks", () => {
  ...
  assert.deepEqual(presets.sort(), ["expo", "express", "laravel", "laravel/inertia", "laravel/livewire", "laravel/react", "laravel/svelte", "laravel/vue", "php", "react", "react-native", "typescript"]);
});
