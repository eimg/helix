...
- **M3+ — Scale.** Web UI; **Manage** (experimental, web/API only — [`docs/manage.md`](./docs/manage.md)); observability; repo context (see [`docs/repo-context.md`](./docs/repo-context.md)); more providers & triggers; subprocess isolation.
